UPDATE No_Inbound SET Inbound_Quantity = Inbound_Quantity + (CAST(:Real_Inbound_Quantity AS DECIMAL) + :Discount_Inbound_Quantity) * :Inbound_Packing_Size,
		Inbound_Piece = Inbound_Piece + CAST(:Real_Inbound_Piece AS INT8) + :Discount_Inbound_Piece,
