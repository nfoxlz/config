SELECT T1.Bill_Type, 
		...
		T1.Purchasing_Piece,
		T1.Purchasing_Amount::NUMERIC,
		T1.Real_Purchasing_Amount::NUMERIC,
		T1.Input_Tax_Rate,
		T1.Real_Purchasing_Amount::NUMERIC * T1.Input_Tax_Rate Tax_Amount,
		T2.Retail_Price * T1.Purchasing_Quantity * T1.Purchasing_Packing_Size / T2.Retail_Packing_Size Retail_Amount,
		T1.Payment_Amount::NUMERIC,
		T1.Real_Payment_Amount::NUMERIC,
		(T1.Real_Purchasing_Amount - T1.Payment_Amount)::NUMERIC No_Payment_Amount,
		T1.Creator_User_Id,
